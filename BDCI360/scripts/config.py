...
parser.add_argument('--embed-path', type=str, help='embedding dimension')
parser.add_argument('--input-type', type=str, default='char', help='type of input data, word or char')

parser.add_argument('--word_vocab', type=int, default=1485695, help='word vocab size')
parser.add_argument('--char_vocab', type=int, default=14804, help='char vocab size')
...
parser.add_argument('--gpu', type=str, default="0", help='use which gpu to run training, optional 0, 1')
...
parser.add_argument('--log-interval', type=int, default=50, help='report interval')
